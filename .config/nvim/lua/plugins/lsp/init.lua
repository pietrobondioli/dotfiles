...
return {
	{
		...
		opts = {
			...
			diagnostics = {
				...
				signs = {
					text = {
						[vim.diagnostic.severity.ERROR] = require("config.defaults").icons.diagnostics.Error,
						[vim.diagnostic.severity.WARN] = require("config.defaults").icons.diagnostics.Warn,
						[vim.diagnostic.severity.HINT] = require("config.defaults").icons.diagnostics.Hint,
						[vim.diagnostic.severity.INFO] = require("config.defaults").icons.diagnostics.Info,
					},
				},
			},
