...
map("n", "<leader>ub", function()
	Utils.toggle("background", false, { "light", "dark" })
...
map("n", "<leader>gf", function()
	if not Utils.git.is_git_directory() then
		Utils.lazy_notify("Current project is not a git directory", "WARN", { title = "Telescope Git Files" })
	else
